...
public class ExampleWhereClauseElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        outerIterateElement.addAttribute(new Attribute(
                "property", "oredCriteria"));  //$NON-NLS-2$
        ...
        outerIterateElement.addAttribute(new Attribute(
                "removeFirstPrepend", "iterate"));  //$NON-NLS-2$
        ...
        isEqualElement.addAttribute(new Attribute(
                "property", "oredCriteria[].valid"));  //$NON-NLS-2$
        ...
        innerIterateElement.addAttribute(new Attribute(
                "property", "oredCriteria[].criteriaWithoutValue"));  //$NON-NLS-2$
        ...
        innerIterateElement.addAttribute(new Attribute("prepend", "and"));  //$NON-NLS-2$
        innerIterateElement.addAttribute(new Attribute(
                "property", "oredCriteria[].criteriaWithSingleValue"));  //$NON-NLS-2$
        innerIterateElement.addAttribute(new Attribute("conjunction", "and"));  //$NON-NLS-2$
        innerIterateElement
        ...
        innerIterateElement.addAttribute(new Attribute("prepend", "and"));  //$NON-NLS-2$
        innerIterateElement.addAttribute(new Attribute(
                "property", "oredCriteria[].criteriaWithListValue"));  //$NON-NLS-2$
        innerIterateElement.addAttribute(new Attribute("conjunction", "and"));  //$NON-NLS-2$
        innerIterateElement.addElement(new TextElement(
        ...
        innerInnerIterateElement
                .addAttribute(new Attribute("conjunction", ","));  //$NON-NLS-2$
        ...
        innerIterateElement.addAttribute(new Attribute("prepend", "and"));  //$NON-NLS-2$
        innerIterateElement.addAttribute(new Attribute(
                "property", "oredCriteria[].criteriaWithBetweenValue"));  //$NON-NLS-2$
        innerIterateElement.addAttribute(new Attribute("conjunction", "and"));  //$NON-NLS-2$
        innerIterateElement.addElement(new TextElement(
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable
            ...
            if (stringHasValue(introspectedColumn
                ...
                innerIterateElement = new XmlElement("iterate"); 
                innerIterateElement
                        .addAttribute(new Attribute("prepend", "and"));  //$NON-NLS-2$
                ...
                innerInnerIterateElement.addAttribute(new Attribute("property", 
                        sb2.toString()));
                innerInnerIterateElement
                        .addAttribute(new Attribute("open", "("));  //$NON-NLS-2$
                innerInnerIterateElement.addAttribute(new Attribute(
                        "close", ")"));  //$NON-NLS-2$
                innerInnerIterateElement.addAttribute(new Attribute(
                        "conjunction", ","));  //$NON-NLS-2$
