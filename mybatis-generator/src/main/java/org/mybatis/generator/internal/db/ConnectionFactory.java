...
public class ConnectionFactory {
	...
	public Connection getConnection(DataBaseType dataBaseType, JDBCConnectionConfiguration config) throws SQLException {
		Driver driver = getDriver(dataBaseType, config.getDriverClass());
	...
	public Driver getDriver(DataBaseType dataBaseType, String driverClass) {
		Driver driver;
		try {
			Class<?> clazz = ObjectFactory.externalClassForName(dataBaseType, driverClass);
